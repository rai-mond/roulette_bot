    ...
    !function() {
        ...
        !function() {
            function f() {
                ...
                _ && (r.lcp = _.lcp && void 0 !== _.lcp.value ? _.lcp : r.lcp,
                r.fid = _.fid && void 0 !== _.fid.value ? _.fid : r.fid,
                r.cls = _.cls && void 0 !== _.cls.value ? _.cls : r.cls),
                g && (r.siteToken = g.token),
                r
            }
            function d(r) {
                var o = l.timing
            ...
            if (!g || "single" !== g.load) {
                ...
                if (l && g && g.token) {
                    ...
                    document.addEventListener("visibilitychange", function() {
                        ...
                        "hidden" === document.visibilityState && !R && L && (R = !0,
                        I(k))
                    });
                    var _ = {
                        lcp: void 0,
                      ...
                      , B = function(e) {
                        ...
                        if ("CLS" === e.name) {
                            ...
                            var n = O(e.entries);
                            n && (_.cls.element = P(n.node),
                            _.cls.currentRect = n.currentRect,
                            _.cls.previousRect = n.previousRect)
                        } else if ("FID" === e.name) {
                            _.fid = {
                                value: e.value,
                                path: t
                            ...
                            var n = C(e.entries);
                            n && (_.lcp.element = P(n.element),
                            _.lcp.size = n.size,
                            _.lcp.url = n.url)
                        }
                    };
                    "function" == typeof PerformanceObserver && (a.getLCP(B, !0),
                    a.getFID(B),
                    PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && a.getCLS(B, !0));
                    var k = g && (void 0 === g.spa || !0 === g.spa)
                      ...
                      , j = function(e) {
                        var t = function(e, t) {
                            ...
                            void 0 !== g.forward && void 0 !== g.forward.url && o.sendObjectBeacon("", n, function() {}, !1, g.forward.url))
                        }
                          , n = d(e);
                        if (n && g) {
                      ...
                      , I = function(e) {
                        ...
                        g && o.sendObjectBeacon("", t, function() {}, !0, A)
                    }
                      , N = function() {
                        L = !0;
